...
public class SongAdapter extends ArrayAdapter<Song> {
	...
	public View getView(int arg0, View arg1, ViewGroup arg2) {
			...
			((TextView)c.findViewById(R.id.textView1)).setText(Songs.get(arg0).Name);
			ProgressBar C = ((ProgressBar)c.findViewById(R.id.progressBar1));
			C.setMax(100);
			C.setProgress((int)Math.round(CT.popularity*100));
			((TextView)c.findViewById(R.id.tvPopularity)).setText(String.valueOf(Math.round(Songs.get(arg0).popularity*100))+"%");
		// TODO Auto-generated method stub
		return c;	
	}
